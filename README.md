...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60680db65591c500175b24df
...
To start editing your site, you can use the Sanity interface at https://aleksbasarablog-80db6.sanity.studio/.
...
Generated at `2021-04-03T06:41:13.123Z` by Stackbit version `0.3.50`.